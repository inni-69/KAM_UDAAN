...
const InteractionForm = () => {
    ...
    useEffect(() => {
        const fetchInteraction = async () => {
            try {
                ...
                const res = await axios.get(`https://kam-udaan-4.onrender.com/api/interactions/${id}`, {
                    headers: {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                ...
                const res = await axios.get(`https://kam-udaan-4.onrender.com/api/contacts/restaurant/${currentRestaurantId}`, {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            if (isEdit) {
                await axios.put(
                    `https://kam-udaan-4.onrender.com/api/interactions/${id}`,
                ...
                await axios.post(
                    'https://kam-udaan-4.onrender.com/api/interactions',
                            ...
                            {!isEdit && ( // Only show contact selection in create mode
                                <div>
                                    ...
                                    {loadingContacts ? (
                                        ...
                                        <p className="text-blue-600 text-sm">{contactsError}</p>
                                    ) : (
                                        <select
                                            id="contactId"
                                            name="contactId"
