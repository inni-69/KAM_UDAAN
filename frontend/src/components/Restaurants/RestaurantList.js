    ...
    const RestaurantList = () => {
        ...
        useEffect(() => {
            const fetchRestaurants = async () => {
                try {
                    const res = await axios.get('https://kam-udaan-4.onrender.com/api/restaurants');
            ...
            <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <Link
                            to="/restaurants/new"
                            className="bg-pink-600 hover:bg-pink-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-300 ease-in-out"
                        >
                            Add New Restaurant
                        </Link>
                    </div>
